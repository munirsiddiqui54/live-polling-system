...
function TeacherDashboard() {
  ...
  // Show results when poll is created/active
  if (currentPoll || (results && !currentPoll)) {
    // Use results if available, otherwise show empty state for currentPoll
    const displayResults = results || {
      question: currentPoll?.question || '',
      options: currentPoll?.options?.map(opt => ({ ...opt, voteCount: 0 })) || [],
      totalResponses: 0
    };
    
    const totalVotes = displayResults.options.reduce((sum, opt) => sum + opt.voteCount, 0);
          ...
          <div className="max-w-4xl mx-auto pt-10">
            ...
            <div className="mb-4 flex items-center justify-end">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-primary hover:bg-primary-dark text-white font-semibold rounded-full transition-all shadow-md"
              >
            ...
            <div className="bg-white rounded-2xl  p-8">
              ...
              <div className=" text-white rounded-lg border border-neutral-dark mb-6">
                <p className="text-lg bg-neutral-dark p-4 mb-6 rounded-t-lg">{displayResults.question}</p>
     

              <div className="space-y-4 m-4">
                {displayResults.options.map((option) => {
              ...
              {/* <div className="text-center mb-6 text-neutral-gray">
                <p>Total Responses: {displayResults.totalResponses}</p>
              </div> */}
                       </div>
              ...
              <div className="flex justify-center gap-4">
                {currentPoll && (
                  <button
                    ...
                    className="px-8 py-3 bg-neutral-gray hover:bg-neutral-dark text-white font-semibold rounded-full transition-all"
                  >
                    End Poll
                  </button>
                )}
          ...
          <div className="bg-white rounded-2xl p-8">
            ...
            <div className="flex justify-end gap-4">
              ...
              <button
                ...
                disabled={!canCreatePoll && currentPoll}
